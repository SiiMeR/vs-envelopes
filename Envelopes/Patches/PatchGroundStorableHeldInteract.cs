...
public static class PatchCollectibleHeldInteractStart
{
    [HarmonyPrefix]
    public static bool Prefix(EntityAgent byEntity, BlockSelection blockSel, ref EnumHandHandling handling)
    {
